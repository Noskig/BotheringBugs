...
{
    public class BBTickerService : IBBTicketService
    {
        private readonly ApplicationDbContext _context;
        private readonly IBBRolesService _rolesService;
        private readonly IBBProjectService _projectService;

        public BBTickerService(ApplicationDbContext context,
                                IBBRolesService rolesService,
            ...
            try
            {
                if (ticket != null)
                {
                    try
                    {
                        ...
                        //Revist when assingning Tickets;
        ...
        public async Task<BBUser> GetTicketDeveloperAsync(int ticketId, int companyId)
        {
            ...
            try
            {
                ...
                {
                    developer = ticket.DevelopeerUser;
                }
                return developer;
            }
            catch (Exception)
