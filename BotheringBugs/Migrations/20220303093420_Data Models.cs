...
namespace BotheringBugs.Migrations
{
    public partial class DataModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BBUserProject", x => new { x.MembersId, x.ProjectsId });
                    table.ForeignKey(
                        name: "FK_BBUserProject_AspNetUsers_MembersId",
                        column: x => x.MembersId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BBUserProject_Projects_ProjectsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Ivites", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Ivites_AspNetUsers_InviteeId",
                        column: x => x.InviteeId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Ivites_AspNetUsers_InvitorId",
                        column: x => x.InvitorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Ivites_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Ivites_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DevelopeerUserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Tickets", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Tickets_AspNetUsers_DevelopeerUserId",
                        column: x => x.DevelopeerUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BBUserId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Notifications", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Notifications_AspNetUsers_BBUserId",
                        column: x => x.BBUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketHistories_AspNetUsers_BBUserId",
                        column: x => x.BBUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BBUserProject_ProjectsId",
                table: "BBUserProject",
                column: "ProjectsId");

            migrationBuilder.CreateIndex(
                name: "IX_Ivites_CompanyId",
                table: "Ivites",
                column: "CompanyId");

            migrationBuilder.CreateIndex(
                name: "IX_Ivites_InviteeId",
                table: "Ivites",
                column: "InviteeId");

            migrationBuilder.CreateIndex(
                name: "IX_Ivites_InvitorId",
                table: "Ivites",
                column: "InvitorId");

            migrationBuilder.CreateIndex(
                name: "IX_Ivites_ProjectId",
                table: "Ivites",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Notifications_BBUserId",
                table: "Notifications",
                column: "BBUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistories_BBUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tickets_DevelopeerUserId",
                table: "Tickets",
                column: "DevelopeerUserId");
